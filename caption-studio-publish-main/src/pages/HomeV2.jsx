      ...
      <nav className="sticky top-0 z-50 h-16 border-b border-white/[0.07] bg-[#080807]/70 px-3 shadow-[0_10px_50px_rgba(0,0,0,0.18)] backdrop-blur-2xl sm:px-4 lg:px-5">
        <div className="mx-auto flex h-full max-w-[90rem] items-center justify-between">
          ...
          <div className="hidden items-center gap-7 sm:flex">
            ...
            <Link to={`${createPageUrl('Dashboard')}?entry=editor`} className="landing-button rounded-[4px] px-3.5 py-2 text-sm font-semibold">Open editor</Link>
          </div>
          <Link to={`${createPageUrl('Dashboard')}?entry=editor`} className="landing-button rounded-[4px] px-3 py-2 text-xs font-semibold sm:hidden">Try free</Link>
        </div>
      </nav>
