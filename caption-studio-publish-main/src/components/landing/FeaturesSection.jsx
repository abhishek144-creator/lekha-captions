...
const features = [
  ...
  { icon: Globe, number: '04', title: 'Every Regional Language', description: '115+ languages including South Asian, African, Southeast Asian, Middle Eastern, and European regional languages. Powered by Sarvam AI for Indian languages and Whisper for global languages.', className: 'md:col-span-2 lg:col-span-1', accent: 'from-cyan-500/15 via-cyan-500/5 to-transparent' },
  { icon: Languages, number: '05', title: 'Multi-Language', description: 'Support for 115+ languages including Hindi, Tamil, Telugu, Marathi, Bengali & more.', accent: 'from-emerald-500/15 via-emerald-500/5 to-transparent' },
    ...
    <section id="features" aria-label="Features" className="relative py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <p className="max-w-xl text-base leading-7 text-white/50 lg:justify-self-end sm:text-lg">Professional tools designed specifically for Indian short-form creators — now ready for audiences across the world.</p>
        </motion.div>
