        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.1] bg-[#0d0c0b]/70 p-6 shadow-[0_40px_100px_-55px_rgba(245,166,35,0.5)] backdrop-blur-2xl sm:p-10 lg:p-12">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[0.65fr_1.35fr] lg:gap-16">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <Link to={`${createPageUrl('Dashboard')}?entry=editor`} className="landing-button group mt-7 inline-flex items-center gap-2 rounded-md px-4 py-2.5 text-sm font-semibold">Start with a video <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></Link>
            </motion.div>
