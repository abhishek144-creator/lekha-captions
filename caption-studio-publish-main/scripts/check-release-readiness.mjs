...
assertIncludes("render MIG can scale to zero", terraformMain, "min_replicas    = 0")
assertIncludes("baseline render capacity defaults to zero", terraformVariables.replace(/\r\n/g, "\n"), 'variable "render_worker_min_replicas" {\n  type        = number\n  description = "Minimum render workers; zero lets idle render capacity scale completely to zero"\n  default     = 0')
