...
const mediaScanJobs = readText("backend/media_scan_jobs.py")
const schedulerAuth = readText("backend/scheduler_auth.py")
...
assertIncludes("scheduler can recover transcription outbox delivery", backendMain, "/api/maintenance/transcription-dispatch")
assertIncludes("scheduler can recover media-scan outbox delivery", backendMain, "/api/maintenance/media-scan-dispatch")
...
assertIncludes("payment reconciliation has a scheduler endpoint", backendMain, "/api/maintenance/payment-reconciliation")
